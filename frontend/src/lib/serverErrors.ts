...
export const SERVER_ERRORS: Record<string, ServerErrorEntry> = {
  ...
  // payroll
  "payroll.required": { i18nKey: "validation.required" },
  "payroll.code_taken": { field: "code", i18nKey: "serverErrors.payroll.codeTaken" },
  "payroll.user_taken": { i18nKey: "serverErrors.payroll.userTaken" },
  "payroll.user_not_found": { i18nKey: "serverErrors.payroll.userNotFound" },
  "payroll.ptkp_invalid": { i18nKey: "serverErrors.payroll.ptkpInvalid" },
  "payroll.salary_negative": { i18nKey: "serverErrors.common.amountNegative" },
  "payroll.commission_negative": { i18nKey: "serverErrors.common.amountNegative" },
  "payroll.amount_negative": { i18nKey: "serverErrors.common.amountNegative" },
  "payroll.allowance_label_required": { i18nKey: "validation.required" },
  "payroll.allowance_negative": { i18nKey: "serverErrors.common.amountNegative" },
  "payroll.label_required": { i18nKey: "validation.required" },
  "payroll.kind_invalid": { i18nKey: "errors.generic" },
  "payroll.period_invalid": { i18nKey: "serverErrors.payroll.periodInvalid" },
  "payroll.period_exists": { i18nKey: "serverErrors.payroll.periodExists" },
  "payroll.run_not_editable": { i18nKey: "serverErrors.payroll.runNotEditable" },
  "payroll.invalid_transition": { i18nKey: "serverErrors.payroll.invalidTransition" },
  "payroll.config_required": { i18nKey: "validation.required" },
  "payroll.config_invalid": { i18nKey: "serverErrors.payroll.configInvalid" },
  "payroll.missing_channel_code": { i18nKey: "serverErrors.payroll.missingChannelCode" },
  "payroll.pay_method_invalid": { i18nKey: "errors.generic" },
  // payment integration
  "payment.no_provider": { i18nKey: "serverErrors.payment.noProvider" },
  "payment.unknown_provider": { i18nKey: "serverErrors.payment.unknownProvider" },
  "payment.credentials_incomplete": { i18nKey: "serverErrors.payment.credentialsIncomplete" },
  "payment.retry_not_failed": { i18nKey: "serverErrors.payment.retryNotFailed" },
  // sale (POS)
