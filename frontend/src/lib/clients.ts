...
import { EmployeeService } from "../gen/payroll_iface/v1/payroll_connect";
import { PayrollService } from "../gen/payroll_iface/v1/payroll_connect";
import { PaymentIntegrationService } from "../gen/payment_iface/v1/payment_connect";
import { DisbursementService } from "../gen/payment_iface/v1/payment_connect";
...
export const employeeClient = createPromiseClient(EmployeeService, transport);
export const payrollClient = createPromiseClient(PayrollService, transport);
export const paymentIntegrationClient = createPromiseClient(PaymentIntegrationService, transport);
export const disbursementClient = createPromiseClient(DisbursementService, transport);
