...
import { ProductRecipeService } from "../gen/inventory_iface/v1/product_recipe_connect";
...
import { TableService } from "../gen/table_iface/v1/table_connect";
...
export const priceAgreementClient = createPromiseClient(PriceAgreementService, transport);
export const productDiscountClient = createPromiseClient(ProductDiscountService, transport);
export const productPriceTierClient = createPromiseClient(ProductPriceTierService, transport);
export const productRecipeClient = createPromiseClient(ProductRecipeService, transport);
...
export const purchaseReturnClient = createPromiseClient(PurchaseReturnService, transport);
